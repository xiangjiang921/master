      ...
      <el-form :model="dialogData" :rules="rules" ref="ruleForm" label-width="80px">
        <div class="card-tab">
          ...
          <el-form-item label="会员号:" prop="cardNumber">
            <div class="flex-row">
              <el-input v-model.trim="dialogData.cardNumber" size="small" class="input" placeholder></el-input>
              <el-button type="primary" style="margin-left:12px;align-self:center" size="small">刷会员卡</el-button>
            </div>
          </el-form-item>
          <div class="flex-row">
        ...
        <div class="card-tab buttonStyle">
          <el-button type="primary" @click="next" size="small" style="width: 120px;">下 一 步</el-button>
        </div>
      </el-form>
    </el-card>
  </div>
