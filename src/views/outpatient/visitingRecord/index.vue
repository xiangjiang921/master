  ...
  <div class="app-body">
    ...
    <div class="drugs">
      <el-table :data="data" border size="small" :height="height" v-loading="dataLoading">
        ...
        <el-table-column prop="iphone" label="就诊时间" align="center"></el-table-column>
        <el-table-column prop="validDate" label="手机号" width="150" align="center">
          <template slot-scope="scope">
            <span>{{scope.row.validDate | dataFrm}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="amount" width="80" label="就诊状态" align="center"></el-table-column>
